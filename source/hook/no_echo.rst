.. hook:: H_NOECHO
  ...
  .. todo:: this was formerly documenting H_TELNET_NEG, which I think was probably a mistake, though I'm not 100% sure; needs to be clarified.
  ...
  .. warning:: If this hook is used, the control of all telnet negotiation is transferred to the mudlib: all incoming negotiations are passed to H_TELNET_NEG, and the sending of no-echo negotiations is handled by this hook.

  :history 3.2.11/3.3.593 changed: added the <no_telnet> argument.

  .. seealso:: :concept:`hooks`, :concept:`telnet`, :hook:`telnet_neg`
