.. hook:: H_RESET
  ...
  :arg closure value: void|int <closure> ( void )
  :arg string value: void <name>(1)
  ...
  .. note:: an object is only reset by call to this hook if it has been used since the last reset.
