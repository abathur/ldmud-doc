.. hook:: H_MODIFY_COMMAND
  ...
  :arg closure value: int|string <closure>(string cmd, object player)
  :arg string value: int|string <name>(string cmd)
  :arg mapping value: <mapping>
  ...
  .. seealso:: :concept:`hooks`, :hook:`command`, :hook:`modify_command_fname`, :hook:`notify_fail`, :hook:`send_notify_fail`
