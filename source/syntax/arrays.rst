.. type:: array
  literal constructor: ({})
  :name: arrays
  :topics: types, literals, vectors

  .. todo:: mega jargon in below intro; I'd be a little surprised if you can find someone who understands all of the jargon that doesn't already know what arrays are.
  ...
  .. todo:: mega jargon in above intro; I'd be a little surprised if you can find someone who understands all of the jargon that doesn't already know what arrays are.
  ...
  .. subtopic:: Operations
    ...
    .. subtopic:: General
      ...
      Of course for any of the operators explained above you can use the combined form of assigning and operating; that means the :operator:`+=`, :operator:`-=` and :operator:`&=` work.
