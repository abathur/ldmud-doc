.. efun:: int cat(string path, int start, int num)
  :removed:
  ...
  :history 3.3.719 deprecated:
  :history 3.5.0 removed:

  .. seealso:: :efun:`get_dir`, :efun:`file_size`, :efun:`read_file`, :efun:`read_bytes`, :master:`valid_read`
