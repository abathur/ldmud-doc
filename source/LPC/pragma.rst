.. lang:: pragma
  ...
  :history 3.2.7 changed: added local_scopes, no_local_scopes, no_clone
    and no_inherit.
  :history 3.2.8 changed: added weak_types, pedantic and sloppy.
  :history 3.2.9 changed: allowed to specify multiple pragmas in one directive.
  :history 3.2.9 changed: added (no_)warn_deprecated.
  :history 3.2.10 changed: added (no_)warn_empty_casts.
  :history 3.2.10 changed: #pragma xxx_types in an included file are
    no longer valid only until the end of the file, but remain active
    when processing returns to the including file.
  :history 3.2.11 changed: added (no_)warn_function_inconsistent.
  :history 3.3.378 changed: added init_variables, share_variables.
  :history 3.3.357 changed: added (no_)warn_missing_return.
  :history 3.3.646 changed: added (no_)range_check.
  ...
  :history 3.5.0 changed: enabled warn_deprecated by default.

  .. seealso:: :lang:`inheritance`, :lang:`initialisation`, :concept:`objects`, :lang:`operators`
