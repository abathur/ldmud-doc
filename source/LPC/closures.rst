.. concept:: closures
  ...
  .. note:: This is the official man page concerning closures. If you find
    it hard to read maybe the Closure Guide is an easier introduction
    for you: See :lang:`closure_guide` and :topic:`closures-example`.
  ...
  :efun:`funcall instead of :efun:`apply` would have given us
  ``ob->func(args)``.

  Of course, besides efuns there are closures for :lang:`operators`,
  like #'+, '-, #'<, #'&&, etc.
  ...
  .. subtopic:: closures-abstract
    ...
    .. subtopic:: Procedural elements:
      ...
      <result>
        one value to be evaluated at the end of the
        execution of the form; the value is returned.
      <lvalue>
        local variable/parameter, global variable, or an
        indexed lvalue.
  ...
  .. seealso:: :topic:`closures-abstract`, :topic:`closures-example`, :lang:`closure_guide`, :lang:`inline-closures`
