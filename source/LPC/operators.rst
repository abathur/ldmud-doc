.. concept:: operators
  ...
  .. todo:: probably want to document all of these with a `.. operator::` directive
  ...
  :history 3.2.9 modified: added '>>>', '>>>=', '&&=' and '||='.
  :history 3.2.10 modified: extended '&' to mappings.
  :history 3.3 modified: extended '|' and '^' to arrays.
