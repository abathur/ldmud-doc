...
# -*- coding: utf-8 -*-
#
# anaphora documentation build configuration file, created by
# sphinx-quickstart on Sun Feb  1 16:56:14 2015.
#
...
# ones.
extensions = ['sphinx.ext.ifconfig', 'sphinx.ext.todo', 'alabaster', 'sphinx.ext.extlinks'
]
...
exclude_patterns = ["*.index", "obsolete/*"] #
...
html_sidebars = { #"globaltoc.html", "relations.html", "about.html",
  "**": ["searchbox.html", "localtoc.html", "navigation.html"]
}
...
latex_documents = [
  ('index', 'lddoc.tex', 'LDMud Documentation',
...
man_pages = [
    ('index', 'lddoc', 'LDMud Documentation',
     ['good question'], 1)
]
...
texinfo_documents = [
  ('index', 'lddoc', 'LDMud Documentation',
   'good question', 'lddoc', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = 'lddoc'
epub_author = 'good question'
epub_publisher = 'good question'
epub_copyright = '2015, good question'

# The basename for the epub file. It defaults to the project name.
#epub_basename = 'anaphora'
...
extlinks = {
  'blart': ('ldmud mantis issue tracker', None),
  'wiki_p': ('https://en.wikipedia.org/wiki/%s', None) #TODO: if we generate multiple languages, worth entertaining whether to also generate wiki links in the native URL
}
