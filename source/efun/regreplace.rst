.. efun:: string regreplace(string txt, string pattern, closure|string replacepattern, int flags)
  :include: <regexp.h>
...
AUTHOR
  ...
  .. seealso:: :efun:`regexp`, :efun:`regexplode`, :efun:`regmatch`, :efun:`regexp_package`,
 :efun:`sscanf`, :efun:`trim`, :concept:`regexp`
