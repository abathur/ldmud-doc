.. efun:: mixed * xml_parse(string xml)
  ...
  .. todo:: the below section probably needs to be recast. It's trying to use the defines in xml.h to tell us that array index 0 will be a string containing the tagname, index 1 will be a mapping with its attributes, and 2 will be a nested mixed * array of parsed subtags.
