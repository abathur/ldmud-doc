.. applied:: int logon (void)
  ...
  If the master attempted a secure connection in :efun:`connect` and
  ...
  .. history
  :history 3.2.10 changed: added the extended meaning for net_connect().
  :history 3.2.13/3.3.713 changed: streamlined the handling of secure connections
    during logon.
