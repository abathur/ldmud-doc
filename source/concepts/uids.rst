.. concept:: uids
  ...
  As uids, euids are assigned at an objects creation through the two aformentioned driverhooks. They can be queried with :efun:`geteuid` and changed with :efun:`seteuid`. Calls to the latter are verified by the master lfun `valid_seteuid()`.
  ...
  .. seealso:: :concept:`native`, :master:`get_root_uid`, :master:`valid_seteuid`, :concept:`objects`, :efun:`clone_object`, :efun:`geteuid`, :efun:`getuid`, :efun:`seteuid`
