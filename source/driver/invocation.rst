.. concept:: invocation
  :synopsis: Description of the invocation of the gamedriver, especially of
    the command arguments. This document describes the commandline version of
  ...
  .. option:: -r u<size>,  --reserve-user <size>

  .. option:: -r m<size>,  --reserve-master <size>

  .. option:: -r s<size>,  --reserve-system <size>
  ...
  .. option:: --gcollect-outfd <filename>, <num>
  ...
  :history 3.2.9 changed: added the --max-thread-pending, --hostname,
    --hostaddr, --args and --random-seed options.
  :history 3.2.10 changed: added the --filename-spaces options.
  :history 3.3.378 changed: added --share-variables, --init-variables.
  :history 3.3.475/3.2.11 changed: added --tls-key, --tls-cert.
  :history 3.3.672/3.2.11 changed: added --tls-trustfile,
    --tls-trustdirectory.
  :history 3.3.677 changed: added --max-mapping-keys.
  :history 3.3.714/3.2.15 changed: added --tls-crlfile, --tls-crldirectory.
  :history 3.3.x changed: added --randominit.
