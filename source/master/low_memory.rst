.. master:: void low_memory(int what, int limitvalue, int memory, int reservestate)
  ...
  .. note:: If in a low_memory condition when the memory reserves have been
  ...
  .. seealso:: :efun:`debug_info`, :efun:`garbage_collection`, :master:`slow_shut_down`, :concept:`memory`, :driver:`malloc`
