.. master:: string valid_write(string path, string uid, string func, object ob)
  ...
  For :efun:`save_object`, the <path> passed is the filename as given
  ...
  :history 3.2.8 changed: adds operation "copy_file", and replaces "do_rename"
    with "rename_from" and "rename_to".
