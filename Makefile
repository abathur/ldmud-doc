...
qthelp:
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/lddoc.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/lddoc.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/lddoc"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/lddoc"
	@echo "# devhelp"
...
plain:
	$(SPHINXBUILD) -b plain $(ALLSPHINXOPTS) $(BUILDDIR)/plain
	@echo
...
doxygen:
	...
	@echo
	@echo "Build finished. The Doxygen files are in $(BUILDDIR)/doxygen."
