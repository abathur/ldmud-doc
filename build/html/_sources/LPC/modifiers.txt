  ...
  .. subtopic:: For functions
    ...
    private
      such functions can only be called with an internal
    ...
    protected
      such functions can be called from within the object,
    ...
    public
      this is the default type. Such functions can be called
    ...
    nomask
      such functions cannot be overridden by inheriting
    ...
    varargs
      this changes the syntax of the function in a way that
    ...
    deprecated
      Whenever this function is called, a warning is issued.
  ...
  .. subtopic:: For object-global variables
    ...
    private
      such variables can only be accessed from within the
    ...
    nosave
      such variables are neither stored with save_object()
    ...
    public
      declares the variable public. It cannot be declared
      private or static by inheriting. No error will occur,
      only the type will not be modified by the inherit
      statement.

    deprecated
      Whenever this variable is used, a warning is issue.
  ...
  virtual
    inherits the given object virtually. This only makes
  ...
  .. seealso:: :lang:`closures`, :lang:`inheritance`, :lang:`functions`, :lang:`types`
