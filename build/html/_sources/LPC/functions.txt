.. concept:: functions
  ...
  .. subtopic:: DEFINING A FUNCTION
    ...
    .. syntax:: function_declaration
      [<modifier>...] [<type>] <name> ([<argument>...]) <block>
    ...
    ``<modifiers>``
      can be any one of "static", "private", "public" and "protected" (see :lang:`modifiers`), optionally combined with "varargs" (see :lang:`varargs`) and/or "nomask". If not specified, the function behaves as if it was specified as "public", but this visibility can be restricted in derived object through non-public inheritance.
    ...
    ``{ statements... }``
      defines the code for this function. This is a normal block (see :lang:`block`) and as such can define its own local variables.
  ...
  .. subtopic:: CALLING A FUNCTION
    ...
    .. note:: See the entry H_DEFAULT_METHOD in :concept:`hooks` for a modification of this behaviour.
  ...
  .. seealso:: :lang:`types`, :lang:`modifiers`, :lang:`varargs`, :lang:`references`, :efun:`call_other`, :concept:`simul_efun`, :efun:`call_out`
