.. lang:: escape
  :synopsis: character escape codes
  ...
  .. todo:: slashes need escaping, but I'd like to wait to see if they can be a good test case for a linter rule to detect things that probably need escaping.
