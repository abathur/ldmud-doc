.. lang:: closures
  ...
  .. note:: This is the official man page concerning closures. If you find it hard to read maybe the Closure Guide is an easier introduction for you: See :guide:`closures` and :topic:`closures example`.
  ...
  The :keyword:`foreach` loop also has a closure form::
  ...
  b. Isn't it a security risk to pass, say, a closure to the master object which then evaluates it with all the permissions it got?
    ...
    .. todo:: privilege violation below
  ...
  .. todo:: should operator closures/keywords/etc. have their own proper definitions (i.e., that can be cross-referenced?)
  ...
  .. subtopic:: closures-abstract
    ...
    .. todo:: should below be more formal grammar spec?
  ...
  .. seealso:: :topic:`closures example`, :guide:`closures`, :syntax:`inline-closures`
