.. syntax:: functions
  function declaration: [<modifier>...] [<type>] <name> ([<argument>...]);
  function definition: [<modifier>...] [<type>] <name> ([<argument>...]) {
    :   statements...
    : }
  ...
  .. subtopic:: Defining A Function
    ...
    ``<modifiers>``
      can be any one of "static", "private", "public" and "protected" (see :syntax:`modifiers`), optionally combined with "varargs" (see :keyword:`varargs`) and/or "nomask". If not specified, the function behaves as if it was specified as "public", but this visibility can be restricted in derived object through non-public inheritance.
    ...
    ``{ statements... }``
      defines the code for this function. This is a normal block (see :syntax:`block`) and as such can define its own local variables.

  .. subtopic:: Declaring A Function
    ...
    .. syntax:: [<modifier>...] [<type>] <name> ([<argument>...]);
  ...
  .. subtopic:: Calling A Function
    ...
    .. note:: See the entry :hook:`H_DEFAULT_METHOD` in :overview:`hook` for a modification of this behaviour.
  ...
  .. subtopic:: Functions And Inheritance
  ...
  .. seealso:: :topic:`types`, :syntax:`modifiers`, :keyword:`varargs`, :syntax:`reference`, :efun:`call_other`, :concept:`simul_efun`, :efun:`call_out`
