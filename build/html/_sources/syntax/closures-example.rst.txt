.. topic:: closures example

  This document contains small examples of the usage of (lambda-)closures. For technical details see the :type:`closure` doc. For hints when to use which type of closure, see the end of this doc.
  ...
  .. seealso:: :type:`closure`, :guide:`closures`, :subtopic:`closures-abstract`
