.. type:: int
  ...
  sedecimal literal: 0x11
  binary literal: 0b00010001
  octal literal: 0o21
  char literal: `<character>`
  :title: An integer
  :topics: numbers, characters, literals

  An integer. Normally full 32 bits signed, yielding a range of at least -2,147,483,648 to 2,147,483,647. The exact available range is given by :topic:`predefined` :macro:`__INT_MIN__` and :macro:`__INT_MAX__`.

  .. todo:: "type" doesn't support most of these options, but not clear whether the solution is for these to be documented in a "literals" doc, or for the type directive to start inheriting from syntax
  ...
  .. seealso:: :topic:`types`, :type:`float`, :type:`string`, :modifier:`public`
