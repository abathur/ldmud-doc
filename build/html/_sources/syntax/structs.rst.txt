.. type:: struct
  ...
  .. todo:: properly document, a little daunting
  ...
  Structs are passed by reference. :token:`struct_name`
  ...
  .. usage::
    ...
    .. note:: Using ``#include "monster_coordinate.c"`` instead of :keyword:`inherit` won't work. While the objects would compile, the first call to ``track()`` would cause a runtime error similar to: ``Illegal type to struct->(): struct Coordinate (/monster.c #234), expected struct Coordinate (/monster_tracker.c #552)``
  ...
  .. todo:: efun to_mapping doesn't resolve; should it be mkmapping?

  .. seealso:: :type:`mapping`, :efun:`get_type_info`, :efun:`structp`, :efun:`mkmapping`, :efun:`to_struct`, :efun:`struct_info`, :efun:`baseof`
