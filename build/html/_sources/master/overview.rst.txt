.. overview:: Master-object methods
  :name: master
  ...
  .. subtopic:: master function reference
    ...
    .. security:: Most of these functions are not useful to be called directly from other objects and can be made private or static. Unlike :applied:`create`, these functions that are applied to the master object are found by the interpreter even if not publicly accessible.
    ...
    .. enumerate:: ``parse_command()`` support
      :synopsis: (``!compat``, :macro:`SUPPLY_PARSE_COMMAND` defined)
      :noindex:

      .. todo:: do these uses of noindex work? should they be here?
  ...
  .. seealso:: :overview:`applied`, :overview:`topics`, :overview:`efun`, :overview:`hook`, :overview:`internals`, :overview:`syntax`, :overview:`obsolete`
