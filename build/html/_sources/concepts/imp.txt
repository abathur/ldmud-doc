.. concept:: imp
  ...
  imp packets. It is encoded using :efun:`crypt` and compared to
  ...
  ..note::  The above is only particularly correct nowadays. Recently a
  ...
  .. subtopic:: LAST UPDATED

    Deepthought, 10-Nov-92
    Pepel, 18-Nov-93

  .. seealso:: :efun:`send_imp`, :master:`receive_imp`, :concept:`intermud`
