  ...
  * :concept:`pcre` for the PCRE package
  ...
  .. subtopic:: REGULAR EXPRESSION DETAILS
    ...
    .. list-table::
      ...
      * - `\\c`
        - match character c even if it's one of the special
          characters.
    ...
    .. list-table::
      ...
      * - `\\b`
        - PCRE: word boundary, also used inconjunction with
  ...
  .. seealso:: :concept:`hsregexp`, :concept:`pcre`, :hook:`regexp_package`, :efun:`regexp`, :efun:`regexplode`, :efun:`regmatch`, :efun:`regreplace`, :efun:`regexp_package`, :driver:`invocation`
