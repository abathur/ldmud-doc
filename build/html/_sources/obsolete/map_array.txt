.. efun:: mixed *map_array(mixed *arr, string fun, string|object ob, mixed extra)
  ...
  :history 3.2.6 changed: obsoleted by map().
  :history 3.2.9 changed: not available if driver is compiled without USE_DEPRECATED.
  :history 3.3 removed:

  .. seealso:: :efun:`filter`, :efun:`filter_objects`, :efun:`assoc`, :efun:`intersect_alist`, :efun:`insert_alist`, :efun:`map`, :efun:`map_objects`, :efun:`member`, :efun:`order_alist`, :efun:`sort_array`, :efun:`unique_array`
