.. topic:: variable initialization
  ...
  .. warning:: Do not call ``__INIT()`` yourself, overload, or use it directly in any other way. The implementation of the variable initialization may change at any time.

  :history 3.3.378 changed: the choice between sharing and initializing variables is no longer a fixed configuration choice of the driver and may now be made via #pragma

  .. seealso:: :syntax:`pragma`, :hook:`H_CREATE_OB`, :hook:`H_CREATE_SUPER`, :hook:`H_CREATE_CLONE`, :topic:`invocation`
