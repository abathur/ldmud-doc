.. efun:: mixed * variable_list(object ob, int flags)
...
Its value is created by bin-or'ing together the following flags from
<functionlist.h>:
...
Introduced in LDMud 3.2.10.
  ...
  .. seealso:: :efun:`inherit_list`, :efun:`functionlist`, :efun:`variable_exists`
