.. efun:: mixed * sort_array(mixed *arr, string wrong_order)
...
.. history
  LDMud 3.2.8 added support for extra arguments.
  LDMud 3.3.720 added support for passing a reference to sort in-place.

  .. seealso:: :efun:`transpose_array`, :efun:`filter`, :efun:`map`, :lang:`alists`
