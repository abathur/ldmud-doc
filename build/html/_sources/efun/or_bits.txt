.. efun:: string or_bits(string str1, string str2)
...
-> s3 is now "8 (", ie. a bitstring with bits 3, 4 and 15 set.
  ...
  .. seealso:: :efun:`clear_bit`, :efun:`set_bit`, :efun:`test_bit`, :efun:`next_bit`, :efun:`last_bit`, :efun:`count_bits`, :efun:`and_bits`, :efun:`xor_bits`, :efun:`invert_bits`, :efun:`copy_bits`
