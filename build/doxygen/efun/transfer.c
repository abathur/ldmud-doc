public class efun {
    ...
    * 
    * Move the object \p item to the object \p dest. All kinds of tests are done, and a number is returned specifying the result:
    * 
    * 0: Success.
    ...
    * 
    * @history{
    * deprecated (3.3) -- available only when compiled with USE_DEPRECATED.
    * }
    * 
    * @see efun::move_object(), applied::drop(), applied::get(), applied::prevent_insert(), applied::can_put_and_get(), applied::add_weight()
   **/
   int transfer(object item, object dest);
}
