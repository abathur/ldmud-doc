...
LDMud 3.5.0 made the call on arrays of objects non-optional.
   ...
   See Also: 
      efun::call_other(), efun::call_direct_resolved(), efun::call_resolved(), applied::create(), @ref driver_LPC_pragma "pragma", efun::extern_call(), efun::function_exists(), `functions`, efun::map_objects()
