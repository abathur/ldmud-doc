public class efun {
    ...
    * }
    * 
    * @see @ref driver_LPC_mappings "mappings", efun::mappingp(), efun::m_indices(), efun::m_values(), efun::m_add(), efun::m_delete(), efun::sizeof(), efun::widthof(), efun::unmkmapping(), efun::to_struct()
   **/
   mapping mkmapping(struct st);
}
