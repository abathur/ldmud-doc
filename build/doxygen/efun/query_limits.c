public class efun {
   /**
    * Return an array with the current runtime limits, resp. if @adefault` is true, the default runtime limits. The entries in the returned array are:
    * 
    ...
    * @history{
    * introduced (3.2.7)
    * modified (3.2.9) -- adds LIMIT_CALLOUTS
    * modified (3.3.563) -- adds LIMIT_COST
    * modified (3.3.677) -- adds LIMIT_MAPPING_KEYS, LIMIT_MAPPING_SIZE
    * modified (3.5.0) -- adds LIMIT_MEMORY
    * }
    * 
