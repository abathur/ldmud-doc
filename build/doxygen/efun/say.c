public class efun {
    ...
    *   of a user action (i.e. this_player() is valid), this_player()becomes the initiator.
    ...
    * 
    * tell_object(who, (stringp(arr[i]) ? arr[i] : "-/-")+"n");
    * 
    * }
    * 
    * Object 2 (not living):
    ...
    * 
    * @history{
    * changed (3.3.686) -- added the use of a mapping/struct/object as second
argument.
    * }
    * 
