...
Introduced in @subpage driver_mailto:3.2.1@61 "3.2.1@61".
Made a privileged function in @subpage driver_mailto:3.2.1@84 "3.2.1@84"
LDMud 3.3.318 introduced the ERQ_CB_STRING flag.

   See Also: 
      efun::attach_erq_demon(), @ref driver_concepts_erq "erq"
