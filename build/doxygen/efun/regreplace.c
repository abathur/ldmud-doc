...
AUTHOR
      @subpage driver_mailto:Marcus@TAPPMud "Marcus@TAPPMud" contributed the original idea for the efun and the
      man page.

      See Also: 
         efun::regexp(), efun::regexplode(), efun::regmatch(), efun::regexp_package(),

   efun::sscanf(), efun::trim(), @ref driver_concepts_regexp "regexp"
