...
share_variables pragma.
      ...
      See Also: 
         efun::blueprint(), efun::clonep(), efun::destruct(), efun::clones(), efun::load_name(),

   efun::load_object(), efun::move_object(), @ref driver_concepts_uids "uids", efun::program_name(), @ref driver_LPC_pragma "pragma"
