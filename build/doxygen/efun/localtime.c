public class efun {
   /**
    * Interpret the argument clock as number of seconds since `Jan, 1st, 1970, 0:00`, and return the time in local time in a nice structure. if \p clock is not specified, `time()` is used as default.
    * 
    ...
    * }
    * 
    * @see efun::ctime(), efun::gmtime(), efun::time(), efun::utime()
   **/
   int * localtime(int *uclock);
}
