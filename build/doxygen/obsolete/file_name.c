public class efun {
    ...
    * 
    * @history{
    * changed (3.2.6) -- renamed to object_name(), this old name is
    * }
    * 
    * @see efun::clone_object(), efun::load_name(), efun::load_object(), efun::find_object(), efun::program_name(), efun::rename_object(), efun::object_name()
   **/
   string file_name(object ob);
}
