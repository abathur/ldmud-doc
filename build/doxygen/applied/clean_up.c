public class applied {
   /**
    * @ref driver_hook_clean_up "H_CLEAN_UP" defines a lfun or a closure used to clean up an object. In older drivers this was hardwired to the lfun applied::clean_up().
    * 
    ...
    * 
    * @history{
    * changed (3.2.1) -- function no longer hardwired to the lfun clean_up.
    * }
    * 
    * @see applied::reset(), applied::heart_beat(), efun::call_out(), efun::destruct(), applied::remove(), @ref driver_hook_overview "hook"
   **/
   int <closure>(int ref, object ob)();
}
