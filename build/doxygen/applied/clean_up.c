public class applied {
   /**
    * The hook H_CLEAN_UP defines a lfun or a closure used to clean up an object. In older drivers this was hardwired to the lfun @aclean_up()`.
    * 
    ...
    * }
    * 
    * @see applied::reset(), applied::heart_beat(), efun::call_out(), efun::destruct(), applied::remove()
   **/
   int <closure>(int ref, object ob)();
}
