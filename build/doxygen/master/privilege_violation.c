public class master {
    ...
    * 
    * attach_erq_demon
    * Attach the erq demon to object <arg> with  flag <arg2>.
    * 
    * bind_lambda
    ...
    * Set option <arg2> with value <arg3> as default (<arg>==0) or for object
    * <arg>.
    * 
    * configure_driver
    * Set option <arg1> to value(s) <arg2>.
    * 
    * enable_telnet
    * Enable/disable telnet (<arg2>) for object <arg>.
    * 
    * execute_command
    * Execute command string <arg2> for the object <arg>.
    * 
    * erq
    * At the request <arg2> is to be sent to the erq-demon by the object <who>.
    * 
    * garbage_collection
    * Object <who> calls the efun garbage_collection() with <arg> as filename
    * and <arg2> as flag.
    * 
    * input_to
    * Object <who> redirects the next input from commandgiver <arg>, using
    * <arg2> as value for the flags. This is used for flag values including the
    * 'no bang' option.
    * 
    * limited
    * Execute <arg> with reduced/changed limits 1<arg2> (as return by
    * query_limits()).
    * 
    * mysql
    * Object <who> attempted to execute mySQL efun <arg>.
    * 
    * pgsql
    * Object <who> attempted to execute Postgres efun <arg>.
    * 
    * net_connect
    * Attempt to open a connection to host <arg>, port <arg2>.
    * 
    * nomask simul_efun
    * Attempt to get an efun <arg> via efun:: when it is shadowed by a nomask
    * type simul_efun.
    * 
    * rename_object
    * The object <who> tries to rename the object <arg> to the name <arg2>.
    * 
    * send_udp
    ...
    * 
    * set_driver_hook
    * Set hook <arg> to <arg2>.
    * 
    * set_limits
    * Set limits to <arg> (as returned by query_limits()).
    * 
    * set_max_commands
    * Set the max. number of commands interactive object <arg> can issue per
    * second to <arg2>.
    * 
    * set_this_object
    * Set this_object() to <arg>.
    * 
    * shadow_add_action
    * Add an action to function <arg2> of object <arg> from the shadow <who>
    * which is shadowing <arg>.
    * 
    * shutdown
    * Object <who> calls the efun shutdown with <arg> as argument.
    * 
    * sqlite_pragma
    * Execute pragma statement in SQLite.
    * 
    * symbol_variable
    * Attempt to make a symbol from a hidden inherited variable. <arg> is the
    * object in question, <arg2> the number of the variable in the variable table.
    * 
    * variable_list
    * An attempt to return the variable values of object <arg> is made from a
    * different object <who>.
    * 
    * wizlist_info
...
and "set_limits".
    ...
    * }
    * 
    * @see efun::net_connect(), efun::send_erq(), efun::set_this_object(), efun::rename_object(), @ref driver_concepts_simul_efun "simul_efun", efun::call_out_info(), efun::shadow(), efun::add_action(), efun::bind_lambda(), efun::send_udp(), efun::input_to(), efun::execute_command(), efun::variable_list(), efun::enable_telnet(), @ref driver_concepts_mysql "mysql"
   **/
   int privilege_violation(string op, mixed who, mixed arg, mixed arg2, mixed arg3);
}
