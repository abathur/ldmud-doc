...
@history{
introduced (3.2.1@132) -- The possibility to pass more arguments than formally specified was introduced. Before, the excess arguments were silently ignored.
}

@see @ref driver_LPC_pragma "pragma", efun::apply(), @ref driver_LPC_modifiers "modifiers"
