...
@param value <dirs>
@param value string <closure>(string include_name, string current_file)
...
@see @ref driver_hook_overview "hook", @ref driver_hook_auto_include "auto_include", master::include_file()
